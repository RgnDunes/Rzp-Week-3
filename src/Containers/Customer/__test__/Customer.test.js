...
describe("filling new customer form with invalid data and checking the alert message and number of times alert get's called", () => {
  test("filling new customer form with invalid name", () => {
    const { getByTestId } = render(<Customer />);
    const newCustBtn = getByTestId("newCustBtn");
    fireEvent.click(newCustBtn);
    const custEmailInput = getByTestId("custEmailInput");
    const custContactInput = getByTestId("custContactInput");
    const custNameInput = getByTestId("custNameInput");
    const newCustSubmitBtn = getByTestId("newCustSubmitBtn");
    expect(custEmailInput.value).toBe("");
    expect(custContactInput.value).toBe("");
    expect(custNameInput.value).toBe("");
    ...
    fireEvent.click(newCustSubmitBtn);
  ...
  test("filling new customer form with invalid contact", () => {
    const { getByTestId } = render(<Customer />);
    const newCustBtn = getByTestId("newCustBtn");
    fireEvent.click(newCustBtn);
    const custEmailInput = getByTestId("custEmailInput");
  ...
  test("filling new customer form with invalid email", () => {
    const { getByTestId } = render(<Customer />);
    const newCustBtn = getByTestId("newCustBtn");
    fireEvent.click(newCustBtn);
    const custEmailInput = getByTestId("custEmailInput");
